...
const RERANKER = process.env.RERANKER === 'cohere' ? 'cohere' : 'google';

const GOOGLE_RANK_MODEL = process.env.GOOGLE_RANK_MODEL || 'semantic-ranker-fast-004';

const ALLOWED_MODELS = new Set(
  (process.env.ALLOWED_MODELS || 'gemini-3.7-flash,gemini-3.6-flash,gemini-3.5-flash,gemini-3.5-flash-lite,gemini-3.1-flash-lite,gemini-3.1-flash-lite-preview,gemini-2.5-flash')
...
module.exports = { ALLOWED_MODELS, ALLOWED_ORIGINS, AUDIO_MAX_BYTES, AUDIO_MIME_RE, AUTH_CACHE_TTL_MS, BASE64_RE, COHERE_KEYS, COHERE_RERANK_MODEL, GEMINI_API_KEY, GOOGLE_RANK_MODEL, HISTORY_MAX_CHARS, HISTORY_MAX_MSG, IMAGE_MAX_BYTES, IMAGE_MIME_ALLOWED, LOCATION, PROJECT_ID, RATE_LIMIT_PER_MIN, REQUEST_DEADLINE_MS, RERANKER, SUPABASE_ANON_KEY, SUPABASE_URL, TRANSCRIBE_MODEL, UPSTREAM_429_BACKOFF_MS, UPSTREAM_429_RETRIES, UPSTREAM_TIMEOUT_MS, USAGE_LOG_ON, VERTEX_API_KEY, imageMagicMatches };
