...
module.exports = async function () {
  ...
  // Model halted (finishReason != STOP) three times -> halt note, not cut note.
  ...
  // Halt then clean answer -> second attempt wins, no note.
  ...
  // finishReason arrives in a trailing chunk without text.
  ...
  // Short but complete without stamp -> accepted.
  ...
  // Deadline: no retry when fewer than 5s remain.
