...
const MULTI_CONNECTOR_RE =
  /\b(?:dan|plus|sambil|bersamaan|juga|sekaligus|sekalian|lalu|kemudian|serta|beserta|trus|terus)\b|[+&]|(?<!\b(?:yang|yg)\s+)\b(?:sama|ama|sm)\b(?!\s+(?:dengan|dgn|persis|kaya|kyk|seperti))/i;
