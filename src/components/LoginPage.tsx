          ...
          {view === 'forgot' && (
            ...
            >
              ...
              <button
                ...
                className="w-full h-11 bg-[var(--accent-main)] hover:brightness-110 active:opacity-70 text-white font-semibold rounded-xl flex items-center justify-center gap-2 transition-all disabled:opacity-50 text-[14px]"
              >
                {resetLoading
                  ? <Loader2 className="w-4 h-4 animate-spin" />
